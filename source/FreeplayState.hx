...
class FreeplayState extends MusicBeatState
{
	...
	static var curSelected:Array<Int> = [0, 0, 0, 0, 0];
	...
	private var iconbfArray:Array<HealthIcon> = [];
	...
	override function create()
	{
		...
		{
			case 0:
				DiscordClient.changePresence("In the Freeplay Main Songs", null);
			case 1:
				DiscordClient.changePresence("In the Freeplay Bonus Songs", null);	
			case 2:
				DiscordClient.changePresence("In the Freeplay Secret Songs", null);
			case 3:
				DiscordClient.changePresence("In the Freeplay Cover Songs", null);
			case 4:
				DiscordClient.changePresence("In the Freeplay Old Songs", null);			
		}
		#end
		...
		for (i in 0...WeekData.weeksList.length) {
			...
			if(leWeek.category != freeplayType) continue;
		...
		/*var initSonglist = CoolUtil.coolTextFile(Paths.txt('category'+freeplayType));
		...
		for (i in 0...songs.length)
		{
			...
			var icon2:HealthIcon = new HealthIcon(songs[i].songCharacter);
	...
	override function update(elapsed:Float)
	{
		...
		else if(space)
		{
			if(instPlaying != curSelected[freeplayType])
			{
				...
				Paths.currentModDirectory = songs[curSelected[freeplayType]].folder;
	...
	function changeSelection(change:Int = 0, playSound:Bool = true)
	{
		...
		for (i in 0...iconbfArray.length)
			{
				iconbfArray[i].alpha = 0.6;
			}
	
			iconbfArray[curSelected[freeplayType]].alpha = 1;
