...
class WeekEditorState extends MusicBeatState
{
	...
	var categoryInputText:FlxUIInputText;
	var categoryInt:FlxUINumericStepper;
	...
	function addWeekUI() {
		...
		categoryInputText = new FlxUIInputText(10, weekFileInputText.y + 40, 50, '', 8);
		blockPressWhileTypingOn.push(categoryInputText);
		reloadWeekThing();

		hideCheckbox = new FlxUICheckBox(10, categoryInputText.y + 40, null, null, "Hide Week from Story Mode?", 100);
		...
		tab_group.add(new FlxText(categoryInputText.x, categoryInputText.y - 18, 0, 'Category Number(Main - 1, Bonus - 2, Crossov - 3, Cover - 4, Old - 5):'));
