    ...
    IntroTagColor = '9155ca' --Color of the tag at the end of the box.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'Bonk B-Side-Remake', 300, -305-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'The B-Side Scout.PNG', 300, -305-IntroTagWidth, 260)
