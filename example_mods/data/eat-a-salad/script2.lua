    ...
    IntroTagColor = '65a7cd' --Color of the tag at the end of the box.
    ...
    function onCreate()
        ...
        makeLuaText('JukeBoxSubText', 'Eat A Salad', 300, -305-IntroTagWidth, 220)
        ...
        makeLuaText('JukeBoxSubText2', 'The Scout.PNG', 300, -305-IntroTagWidth, 260)
